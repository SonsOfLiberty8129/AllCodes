...
import org.firstinspires.ftc.teamcode.Trumpware;
...
public class LiterativeTeleOp extends OpMode
{
    ...
    public void loop() {
        ...
        double gripReverse = this.gamepad2.left_trigger;
        ...
        if (Math.abs(gripReverse) < deadzone)
        {
            gripReverse = 0;
        }
        ...
        gripServo.setPower(Range.clip(gripPower, -1, 1));
        gripServo.setPower(Range.clip(-gripReverse, -1, 1));
    }
